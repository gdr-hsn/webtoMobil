...
public class ADAYLAR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adaylar);

        String listk;



VeriTabanik vtk=new VeriTabanik(ADAYLAR.this);


listk=vtk.VeriListelek().toString();


tv11=(TextView)findViewById(R.id.textView75i);
