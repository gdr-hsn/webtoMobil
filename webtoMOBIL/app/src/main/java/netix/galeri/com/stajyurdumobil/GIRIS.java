...
VeriTabani vtt=new VeriTabani(GIRIS.this);
        VeriTabanik vttk=new VeriTabanik(GIRIS.this);
        ...
        button31=(Button)findViewById(R.id.button54545454);
        button31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VeriTabani vtt=new VeriTabani(GIRIS.this);

                eslesme= (EditText) findViewById(R.id.editText7777);
                eslesme2= (EditText) findViewById(R.id.editText8888);
    ...
    if(bll==true){
        Toast.makeText(getApplicationContext(),"GIRIS BASARILI PANELİNİZE YONLENDIRILIYORSUNUZ",Toast.LENGTH_LONG).show();
           ...
           dondur=true;
            ...
            GIRISPANEL.dondur2=false;

Intent in=new Intent(getApplicationContext(),GIRISPANEL.class);
startActivity(in);
